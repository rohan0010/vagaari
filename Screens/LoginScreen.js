                ...
                >
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Animatable.View
                            ...
                            style={{ backgroundColor: 'white', height: 150, width: 200, alignItems: 'center', justifyContent: 'center' }}>
                            <Text style={{ fontWeight: 'bold', fontSize: 20 }}>VAGAARI</Text>
                        </Animatable.View>
                    </View>
